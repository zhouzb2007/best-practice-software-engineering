...
public class EditStudentFrame extends JFrame implements ActionListener {
	 ...
	 */
	private RegexTextField idLabel;
	...
	private void initComponents() {
		...
		// ID
		idLabel = new RegexTextField("<assigned from DB>");
		if (this.mode != Mode.Create) {
			JLabel lblId = new JLabel("Id:");
			centerBox.add(lblId);
			idLabel.setRegex(regexID);
			idLabel.setValidationIndicator(lblId);
	...
	private Student getStudentFromFrame() {
        ...
        if(!idLabel.getText().equals("<assigned from DB>"))
            stud.setId(Long.parseLong(idLabel.getText()));
